...
const procCommand = async (message, sock) => {
  ...
  const expressions = JSON.parse(fs.readFileSync(
      path.resolve(__dirname, '../../../public/expressions.json'), 'utf8'));
  const expression = expressions[getRandomIntInclusive(0,
      expressions.length - 1, {seed: contextInfo.stanzaId})];
