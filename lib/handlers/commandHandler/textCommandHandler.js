...
const translateToCommand = require(
    '../../../bin/commands/otherCommands/translateToCommand');
const searchCommand = require(
    '../../../bin/commands/funCommands/searchCommand');
const {surveyCommand, surveyResults} = require(
    '../../../bin/commands/otherCommands/surveyCommand');
const definitionCommand = require(
    '../../../bin/commands/otherCommands/definitionCommand');
const formatCommand = require(
    '../../../bin/commands/funCommands/formatCommand');
const kickCommand = require('../../../bin/commands/adminsCommands/kickCommand');
const addToSafeGroups = require(
    '../../../bin/commands/groupCommands/addToSafeGroups');
const calculateCommand = require(
    '../../../bin/commands/funCommands/calculateCommand');
...
const deleteCommand = require(
    '../../../bin/commands/otherCommands/deleteCommand');
const permissionCommand = require(
    '../../../bin/commands/otherCommands/permissionCommand');
const deviceCommand = require(
    '../../../bin/commands/otherCommands/deviceCommand');
const schoolCommand = require(
    '../../../bin/commands/otherCommands/schoolCommand');
const reactionCommand = require(
    '../../../bin/commands/otherCommands/reactionCommand');
const blackJackCommand = require('../../../bin/minigames/blackJack');
const polygraphCommand = require(
    '../../../bin/commands/funCommands/polygraphCommand');
const triggeredCommand = require(
    '../../../bin/commands/funCommands/triggeredCommand');
...
const procCommand = async (message, socket, store, miniGames) => {
  ...
  switch (messageParts[0].substr(1)) {
    ...
    case 'קורונה':
      ...
      break;
    case 'טריוויה':
      await miniGames.addGameChat(message.key.remoteJid, Trivia, message,
          socket);
      break;
    case 'תייג':
    ...
    case 'התר':
      ...
      break;
    case 'בוט':
      await socket.sendMessage(message.key.remoteJid, {text: 'עובד'},
          {quoted: message});
      break;
    case 'ויקי':
    ...
    case 'קוד':
      await socket.sendMessage(message.key.remoteJid,
          {text: 'https://github.com/Schwartzblat/sockBot'}, {quoted: message});
      break;
    case 'הסר':
    ...
    case 'חשב':
      ...
      break;
    case 'בול_פגיעה':
      await miniGames.addGameChat(message.key.remoteJid, BullsAndCows, message,
          socket);
      break;
    case 'כנס':
